    ...
    <>
      <div className="p-6 space-y-6 bg-gray-100 ">
        ...
        <div className="bg-linear-to-r from-blue-900 to-indigo-900 text-white rounded-2xl p-6 flex flex-col md:flex-row justify-between gap-6 shadow-lg">
          ...
          {/* Right Card */}
          <div className="bg-white/10 backdrop-blur rounded-2xl p-6 flex flex-col items-center justify-center min-w-[200px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Mild peanut allergy. Wears corrective lenses for distance. No other reported conditions.
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow lg:col-span-2 space-y-4">
          ...
          {/* Table Rows */}
          {[
            { name: "Mathematics", sub: "ADVANCED CALCULUS", score: 94, trend: "+1.1%" },
            { name: "Science", sub: "PHYSICS & BIOLOGY", score: 98, trend: "+2.4%" },
            { name: "English", sub: "LITERATURE & COMP", score: 88, trend: "0.0%" },
            { name: "Thai", sub: "LANGUAGE PROFICIENCY", score: 92, trend: "+1.5%" },
            { name: "Social Studies", sub: "GLOBAL HISTORY", score: 95, trend: "+5.2%" },
          ].map((s) => (
            <div key={s.name} className="grid grid-cols-3 items-center border-b py-3">
              {/* SUBJECT */}
              <div>
              ...
              {/* SCORE */}
              <p className="text-center font-medium text-blue-600">{s.score} / 100</p>

              {/* TREND */}
              <p className={`text-right text-sm ${s.trend.startsWith('+') ? 'text-green-500' : s.trend === '0.0%' ? 'text-gray-400' : 'text-red-500'}`}>
                {s.trend}
              </p>
            </div>
          ))}
