  ...
  return (
    <div className="pt-5 px-2  max-w-5xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 ">
        <div className="p-5 bg-[#f6f6fa] rounded-2xl">
          <IoSchoolOutline className="p-1 bg-[#ffffff] text-2xl rounded-lg shadow text-blue-400" />
          ...
          <p className="text-gray-500 text-[10px] pt-5">Established 1998</p>
        </div>
        <div className="p-5 bg-[#f6f6fa] rounded-2xl">
          <FaUsers className="p-1 bg-[#ffffff] text-2xl rounded-lg shadow text-blue-400" />
          ...
          <p className="text-gray-500 text-[10px] pt-5">Character Building</p>
        </div>
        <div className="p-5 bg-[#f6f6fa] rounded-2xl">
          <TbBellSchool className="p-1 bg-[#ffffff] text-2xl rounded-lg shadow text-blue-400" />
          <h1 className="text-xl font-bold pt-5">Innovation Labs</h1>
          <p className="text-[12px] pt-4">
            Consistently ranked in the top 1% nationally, iSchool provides a
            rigorous yet supportive environment where intellect flourishes.
          </p>
          <p className="text-gray-500 text-[10px] pt-5">Future Ready</p>
        </div>
      </div>
    </div>
  );
