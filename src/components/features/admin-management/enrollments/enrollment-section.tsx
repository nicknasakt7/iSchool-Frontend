  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-card rounded-2xl border p-4 text-center">
          <p className="text-xl font-bold text-amber-500">{waiting}</p>
          <p className="text-sm text-muted-foreground mt-1">Waiting</p>
        </div>
        <div className="bg-card rounded-2xl border p-4 text-center">
          <p className="text-xl font-bold text-green-500">{contacted}</p>
      ...
      <div className="bg-card rounded-2xl border p-4 space-y-3">
        <div className="flex items-center justify-between">
          <p className="text-base font-medium">Interested Leads</p>
